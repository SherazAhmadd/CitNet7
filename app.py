...
if app_mode == "Home":
    ...
    st.markdown("""
        ...
        2. Upload an image of a citrus plant leaf.
    ...
    st.markdown("""
        ...
        - **LinkedIn:** [Rana Sheraz Ahmad](https://www.linkedin.com/in/rana-sheraz-5a0b3a1b7/)
...
if app_mode == 'Disease Detection':
    ...
    if uploaded_file is not None:
        st.image(uploaded_file, caption="Uploaded Image", width=300)  # Resize the image using the `width` parameter
